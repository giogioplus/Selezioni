namespace SelezioniRep
{
    ...
    /// </summary>
    public partial class SchedaRepDom : Telerik.Reporting.Report
    {
        private int SelezioneId;
        private Selezione oSelezione;
        ClsDB DBUtility = new ClsDB();
        DataSet ds;
        public SchedaRepDom(int pSelId, string pTipo, int pCompId, string pUtente)
        {
            //
            ...
            if (!DBUtility.ExistsCompilazioniUtente(SelezioneId, oSelezione.CategoriaCod, null, null, pCompId, null, pUtente, null))
            ...
            ds = DatiRep.prepara_info(pSelId, pTipo, pCompId, pUtente);
