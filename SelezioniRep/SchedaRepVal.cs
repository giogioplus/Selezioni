namespace SelezioniRep
{
    ...
    /// </summary>
    public partial class SchedaRepVal : Telerik.Reporting.Report
    {
        private int SelezioneId;
        private Selezione oSelezione;
        ClsDB DBUtility = new ClsDB();
        DataSet ds;
        public SchedaRepVal(int pSelId, string pTipo, int pCompId, string pUtente)
        {
            //
