namespace SelezioniRep
{
    ...
    /// </summary>
    public partial class DettaglioRep : Telerik.Reporting.Report
    {
        public DettaglioRep()
        {
            //
        ...
        public void DettaglioRep_NeedDataSource(object sender, EventArgs e)
        {
            string prova = "";
            try
            {
                ...
                {
                    if (int.Parse(item["ind_id"].ToString()) == 5){
                        intero = intero + 1;
                    }
                    ...
                    //if (ulong.Parse(item["ord"].ToString()) != ord_old)
                    if (item["ord"].ToString() != ord_old) //>>ga092016<<
                    {
                    ...
                    //ord_old = long.Parse(item["ord"].ToString()); //>>ga092016<<
                    ord_old = item["ord"].ToString();//>>ga092016<<
